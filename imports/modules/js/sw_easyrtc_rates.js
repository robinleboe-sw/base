//
// sw_easyrtc_rates.js
// RJB: Modified version to support stereo streams
//
...
//RJB corrected, see: http://tools.ietf.org/pdf/draft-spittka-payload-rtp-opus-03.pdf
          //RJB           sdpLines[fmtpLineIndex] = sdpLines[fmtpLineIndex].concat('; stereo=1');
        ...
        if( isLocal ) {
            ...
            return function(insdp) {
              ...
              var sdp = maybePreferAudioSendCodec(insdp);  //RJB: bugfix
                if (stereo) {
                    sdp = addStereo(sdp);
                }
//RJB: bugfix                var sdp = maybePreferAudioSendCodec(insdp);
